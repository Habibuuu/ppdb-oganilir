                        ...
                        <form class="row g-3 needs-validation"wire:submit.prevent="update">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Contoh : 104.6510159" disabled autofocus wire:model="longitude_siswa">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cara Mengisi Latitude dan Longitude
                    </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="Aktifkan()" class="btn btn-warning close-modal"
