<div>
    ...
    <div class="container-fluid dashboard-default-sec">
            ...
            <div class="col-xl-12 box-col-12 des-xl-100 dashboard-sec">
                <div class="card income-card" style="border-radius:6px;">
                    <div class="card-header">
                        <center><b><i class="fa fa-info-circle"></i> PENGUMUMAN DARI DINAS PENDIDIKAN KABUPATEN OGAN ILIR</b></center>
                    </div>
                    <div class="card-body">
                        <center>
        ...
        <center><h6>BERKAS YANG DIBAWA KE CALON SEKOLAH UNTUK VERIFIKASI DATA CALON SISWA</h6></center>
        <div class="container-fluid dashboard-default-sec">
            <div class="row">
                <div class="col-xl-6 box-col-12 des-xl-100 dashboard-sec">
                    <div class="card income-card" style="background-color: #E6997B;min-height:250px;border-radius:6px;">
                ...
                <div class="col-xl-6 box-col-12 des-xl-100 dashboard-sec">
                    <div class="card income-card" style="background-color: #94D351;min-height:250px;border-radius:6px;">
        ...
        <div class="container-fluid dashboard-default-sec">
            <div class="row">
                <div class="col-xl-6 box-col-12 des-xl-100 dashboard-sec">
                    <div class="card income-card" style="background-color: #00B351;min-height:250px;border-radius:6px;">
