                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                Jumlah Minimal Penerimaan (50% dari {{ $daya_tampung->daya_tampung }}) : {{ $daya_tampung->daya_tampung * 50 / 100 }} Siswa <br>
                                Jumlah Diterima : @php
                                    echo count($data_zonasi). " Siswa";
                                @endphp
                            </div>
                            <div class="col-sm-6">
                                <input style="width: 70%;float:right;" type="search" class="form-control" placeholder="Ketikan Nama Siswa" wire:model="search">
                            </div>
                        </div>
                    </div>
                </div>
